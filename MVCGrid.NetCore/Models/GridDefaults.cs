...
namespace MVCGrid.Models
{
    public class GridDefaults : IMVCGridDefinition
    {
        public GridDefaults()
        {
            ...
            RenderingEngines.Add(MVCGrid.NetCore.Models.RenderingEngine.BootstrapRenderingEngine);
            RenderingEngines.Add(MVCGrid.NetCore.Models.RenderingEngine.ExportDefault);
